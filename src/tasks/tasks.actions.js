import * as tasksServices from './tasks.services';
...
export const createTask = (text) => {
    const thunkAction = function (dispatch) {
        ...
        tasksServices.createTask(taskData).then(() => dispatch(getTaskList()));
    };
...
export const deleteTask = (taskId) => {
    const thunkAction = function (dispatch) {
        tasksServices.deleteTask(taskId).then(() => dispatch(getTaskList()));
    };
